...
class DifyNodeFactory(NodeFactory):
    ...
    def create_node(self, node_config: dict[str, Any] | NodeConfigDict) -> Node:
        ...
        node_init_kwargs_factories: Mapping[NodeType, Callable[[], dict[str, object]]] = {
            ...
            BuiltinNodeTypes.DIAGNOSIS_RULE: lambda: {
                # Diagnosis rule node is self-contained: no LLM, HTTP, or
                # external dependencies needed. All logic runs within the
                # node's own condition tree evaluator.
            },
        }
