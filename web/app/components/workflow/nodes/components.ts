...
import DiagnosisRuleNode from './diagnosis-rule/node'
import DiagnosisRulePanel from './diagnosis-rule/panel'
...
export const NodeComponentMap: Record<string, ComponentType<any>> = {
  ...
  [BlockEnum.DiagnosisRule]: DiagnosisRuleNode,
}
...
export const PanelComponentMap: Record<string, ComponentType<any>> = {
  ...
  [BlockEnum.DiagnosisRule]: DiagnosisRulePanel,
}
